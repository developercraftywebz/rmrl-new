                                        ...
                                        <div class="post-div mt-3">
                                                ...
                                                <div class="row">
                                                    <div class="col-12">
                                                        <ul class="what-post cat-post d-flex justify-content-between gap-2 align-items-end">
                                                            <li class="what-post-item post-name"><h4 class="post-title">Men</h4>
                                                                                                    <p>RMRL</p>
                                                            </li>
                                            ...
                                            <div class="cat-box">
                                                <div class="row">
                                                    <div class="col-12">
                                                        <ul class="what-post cat-post d-flex justify-content-between gap-2 align-items-end">
                                                            <li class="what-post-item post-name"><h4 class="post-title">Women</h4>
                                                                                                    <p>RMRL</p>
                                                            </li>
                                                            <li class="what-post-item post-a"><a href="#">See All</a></li>
                                                        </ul>
                                            ...
                                            <div class="cat-box">
                                                <div class="row">
                                                    <div class="col-12">
                                                        <ul class="what-post cat-post d-flex justify-content-between gap-2 align-items-end">
                                                            <li class="what-post-item post-name"><h4 class="post-title">Nature</h4>
                                                                                                    <p>RMRL</p>
                                                            </li>
                                                            <li class="what-post-item post-a"><a href="#">See All</a></li>
                                                        </ul>
