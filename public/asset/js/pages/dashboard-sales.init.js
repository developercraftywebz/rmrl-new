...
var options = {
    ...
    labels: ['02/01/2024', '02/02/2024', '02/03/2024', '02/04/2024', '02/05/2024', '02/06/2024', '02/07/2024', '02/08/2024', '02/09/2024', '02/10/2024', '02/11/2024'],
    markers: {
        size: 0
    },
    legend: {
...
//
var colors = ['#3bafda', '#1abc9c', "#f672a7"];
var dataColors = $("#products-sales2").data('colors');
if (dataColors) {
    colors = dataColors.split(",");
}
var options = {
...
var chart = new ApexCharts(
    document.querySelector("#products-sales2"),
    options
);
