...
var options = {
    ...
    xaxis: {
        categories: ['12pm', '01pm', '02pm', '03pm', '04pm', '05pm', '06pm', '07pm', '08pm', '09pm', '10pm', '11pm', '12pm'],
    },
    legend: {
        offsetY: 5,
    },
...
// Mixed Chart - 3
//
var colors = ["#3bafda,#ebf2f6,#f672a7"];
...
var colors = ['#3bafda,#1abc9c,#6559cc,#f672a7'];
...
var colors = ['#3bafda', "#1abc9c", "#f672a7", "#f672a7", "#6559cc"];
...
// Pie Chart -1
//
var colors = ["#3bafda", "#1abc9c", "#f7b84b", "#6559cc","#f672a7"];
...
// Radialbar Chart - 2
//
var colors = ["#3bafda", "#f672a7", "#1abc9c", "#f7b84b"];
